<%@ WebHandler Language="C#" Class="RareSpecialityImageUploader" %>
...
public class RareSpecialityImageUploader : IHttpHandler {
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        if (!string.IsNullOrEmpty(id) && !string.IsNullOrEmpty(fnames))
        {
            ...
            var uploaded = new RareSpecialityManager().UpdateRareSpecialityImagesById(id, string.Join(" ", imagesToAdd));
            if (uploaded)
            {
                try
                {
