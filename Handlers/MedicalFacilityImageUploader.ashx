<%@ WebHandler Language="C#" Class="MedicalFacilityImageUploader" %>
...
public class MedicalFacilityImageUploader : IHttpHandler
{
    public void ProcessRequest(HttpContext context)
    {
        ...
        if (!string.IsNullOrEmpty(id) && !string.IsNullOrEmpty(fnames))
        {
            ...
            var uploaded = new MedicalFacilityManager().UpdateMedicalFacilityImagesById(id, string.Join(" ", imagesToAdd));
            if (uploaded)
            {
                try
                {
