<%@ WebHandler Language="C#" Class="DoctorImageUploader" %>
...
public class DoctorImageUploader : IHttpHandler
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        if (!string.IsNullOrEmpty(id) && !string.IsNullOrEmpty(fnames))
        {
            ...
            var uploaded = new DoctorManager().UpdateDoctorImagesById(id, string.Join(" ", imagesToAdd));
            if (uploaded)
            {
                try
                {
