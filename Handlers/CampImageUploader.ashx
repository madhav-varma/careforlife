<%@ WebHandler Language="C#" Class="CampImageUploader" %>
...
public class CampImageUploader : IHttpHandler {
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        if (!string.IsNullOrEmpty(id) && !string.IsNullOrEmpty(fnames))
        {
            ...
            var uploaded = new CampManager().UpdateCampImagesById(id, string.Join(" ", imagesToAdd));
            if (uploaded)
            {
                try
                {
