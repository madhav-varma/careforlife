...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
                                    ...
                                    <div class="x_content">
                                        <form runat="server" id="docform" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="row item form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input type="tel" runat="server" data-rule-number="true" data-rule-minlength="10" data-rule-maxlength="12" id="mobile" name="mobile" required="required" placeholder="Mobile" class="form-control col-md-7 col-xs-12">
                                                </div>
                                            </div>
    ...
    <script id="servicesTemplate" type="text/html">
        <div class="row services-div" data-index="${index}">
            <label class="col-sm-3 control-label">Specialities</label>
            <div class="col-sm-6 ">
