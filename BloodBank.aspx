                    ...
                    <div class="tab-pane active" id="bloodbankedit">
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel" style="border-top: 0">
                                    <div class="x_content">
                                        <form runat="server" id="bloodbankform" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="row item form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input type="tel" data-rule-number="true" data-rule-minlength="10" data-rule-maxlength="12" title="Enter a valid mobile number" runat="server" id="mobile" name="mobile" required="required" placeholder="Mobile" class="form-control col-md-7 col-xs-12">
                                                </div>
                                            </div>
